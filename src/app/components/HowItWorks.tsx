...
function Step({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-2xl font-extrabold tracking-[-0.02em] text-cyan-300">
        {title}
      </h3>
...
export default function HowItWorks() {
  return (
    <section className="relative overflow-hidden bg-[#0a0f1a]">
      ...
      <div className="pointer-events-none absolute -left-24 top-1/3 h-[520px] w-[520px] rounded-full bg-cyan-500/10 blur-3xl" />

      <div className="pointer-events-none absolute right-0 top-1/2 h-[480px] w-[480px] rounded-full bg-indigo-500/10 blur-3xl" />

      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <div className="absolute left-1/2 -z-10 h-48 w-72 -translate-x-1/2 rounded-full bg-cyan-500/20 blur-3xl" />
