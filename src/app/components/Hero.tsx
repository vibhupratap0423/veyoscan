...
export default function Hero({
  ...
  const users = useCountUp({ end: 5000, duration: 1200 });
  const scans = useCountUp({ end: 25000, duration: 1300 });
  const uptime = useCountUp({ end: 99.9, duration: 1400, decimals: 1 });
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-10 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:py-10">
        <div className="space-y-6">
          ...
          <div className="relative">
            ...
            <h1 className="relative z-10 text-5xl font-black leading-[1.1] tracking-[-0.03em] sm:text-7xl">
              <span className="block bg-gradient-to-r from-[#00bfff] to-white bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(34,211,238,0.55)]">
                Scan to Connect
              </span>

              <span className="block bg-gradient-to-r from-white to-[#00bfff] bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(34,211,238,0.55)]">
                Instantly
              </span>
            </h1>
          </div>
          ...
          <div className="relative mx-auto w-full">
            <div className="relative mx-auto aspect-[9/14] w-full max-w-[360px] rounded-[1.8rem] border border-white/15 bg-gradient-to-b from-slate-900 to-slate-950 p-2 shadow-2xl shadow-cyan-500/20">
              ...
              <div className="relative z-10 h-full w-full overflow-hidden rounded-[1.4rem] border border-white/10 bg-black">
                <div className="absolute inset-0 bg-[radial-gradient(70%_60%_at_30%_20%,rgba(34,211,238,0.20),transparent_60%),radial-gradient(70%_60%_at_80%_20%,rgba(99,102,241,0.18),transparent_60%)]" />

                <Image
                  src={imageSrc}
                  alt="VeyoScan scan to connect preview"
                  fill
                  priority
                  fetchPriority="high"
                ...
                <div
                  className="pointer-events-none absolute left-8 right-8 z-10 h-1.5 rounded bg-cyan-400/70 animate-[scanLine_2.4s_linear_infinite]"
                  style={{ top: "50%" }}
                />

                <p className="absolute bottom-4 left-0 right-0 z-10 text-center text-[12px] tracking-wide text-cyan-200">
                  Scanning…
                </p>
              </div>
            </div>
